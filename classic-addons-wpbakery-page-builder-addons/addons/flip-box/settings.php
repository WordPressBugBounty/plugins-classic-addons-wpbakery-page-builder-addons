...
$cawpb_params = array(
	...
	array(
		"type" 			=> "dropdown",
		"heading" 		=> __( 'Flip Style', 'classic-addons-wpbakery-page-builder' ),
		"param_name" 	=> "flip_style",
		"description" 	=> __( 'Choose the flip box rotation style.', 'classic-addons-wpbakery-page-builder' ),
		"group" 		=> 'General',
		"value" 		=> array(
	...
	array(
		"type" 			=> "textfield",
		"heading" 		=> __( 'Flip Box Size', 'classic-addons-wpbakery-page-builder' ),
		"param_name" 	=> "flip_width",
		"description" 	=> __( 'Provide the flipbox max size. e.g: 300px', 'classic-addons-wpbakery-page-builder' ),
		"group" 		=> 'General',
	),
	array(
		"type" 			=> 	"textfield",
	...
	array(
		...
		"description" 	=> 	__( 'Provide body content with your own design. You can use the HTML Tags.', 'classic-addons-wpbakery-page-builder' ),
		"group" 		=> 	'Front',
	),
	array(
        "type" 			=> 	"attach_image",
	...
	array(
		"type" 			=> "colorpicker",
		"heading" 		=> __( 'Box Color', 'classic-addons-wpbakery-page-builder' ),
	...
	array(
		...
		"description" 	=> 	__( 'Provide border style.', 'classic-addons-wpbakery-page-builder' ),
	...
	array(
		...
		"heading" 		=> 	__( 'Content', 'classic-addons-wpbakery-page-builder' ),
		"param_name" 	=> 	"content",
		"description" 	=> 	__( 'Provide the content to display on the back area.', 'classic-addons-wpbakery-page-builder' ),
		"group" 		=> 	'Back',
	...
	array(
		...
		"description" 	=> __( 'Choose the flip back area color.', 'classic-addons-wpbakery-page-builder' ),
		"group" 		=> 'Back',
	),
	array(
		"type" 			=> 	"cawpb_border_style",
