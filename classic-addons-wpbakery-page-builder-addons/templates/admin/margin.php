...
<div class="caw-border-style-wrapper">
	<div class="caw-style-handler" data-border="<?php echo esc_attr($value); ?>">
		...
		<input type="hidden" name="<?php echo esc_attr( $cawpb_param_name ); ?>" class="caw-margin-input-js wpb_vc_param_value <?php echo esc_attr( $cawpb_param_name ) ?> <?php echo esc_attr( $cawpb_param_type ) ?>_field" value="<?php echo esc_attr( $value ); ?>"/>
	</div>
</div>
